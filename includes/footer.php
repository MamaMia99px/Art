        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 mb-4">
                    <h5 class="mb-3">ArtiSell</h5>
                    <p class="text-muted mb-3">
                        Supporting local Cebu artists and craftsmen by providing a platform to showcase and sell their unique creations.
                    </p>
                ...
                <div class="col-md-3 mb-4">
                    ...
                    <div class="mb-2">
                        ...
                        <span class="text-muted">123 Osmeña Blvd, Cebu City, Philippines</span>
                    </div>
                    <div class="mb-2">
                        <i class="fas fa-phone me-2 text-muted"></i>
                        <span class="text-muted">+63 32 123 4567</span>
                    </div>
                    <div class="mb-2">
                        <i class="fas fa-envelope me-2 text-muted"></i>
                        <span class="text-muted">info@artisell.ph</span>
                    </div>
                </div>
                ...
                <div class="col-md-3 mb-4">
                    ...
                    <p class="text-muted mb-3">
                        Subscribe to our newsletter for updates on new artists, products, and events.
                    </p>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    <p class="text-muted mb-0">
                        &copy; <?php echo date('Y'); ?> ArtiSell. All rights reserved.
                    </p>
                </div>
                <div class="col-md-6 text-center text-md-end">
                    <a href="#" class="text-muted text-decoration-none me-3">Privacy Policy</a>
                    <a href="#" class="text-muted text-decoration-none me-3">Terms of Service</a>
                    <a href="#" class="text-muted text-decoration-none">Shipping Policy</a>
                </div>
            </div>
        </div>
    </footer>
